...
public class Server {
    ...
    private static final int SCHEDULE_RUNNER_COUNT = 1;
	...
	scheduler = new Scheduler(SCHEDULE_RUNNER_COUNT, REGISTRY_PORT);
	try {
	    scheduler.setScheduleStorage(ScheduleStorage.generateDebugScheduleStorage(SCHEDULE_RUNNER_COUNT));
	} catch (Exception e) {
	    e.printStackTrace();
	}
    }
