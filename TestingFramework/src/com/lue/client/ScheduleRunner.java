...
public class ScheduleRunner extends UnicastRemoteObject implements ScheduleRunnerIF {
	...
	public ScheduleRunner(int scheduleRunnerId) throws Exception {
	...
	public void connectToScheduler(String host, int port) throws Exception {
		...
		schedulerIF.registerScheduleRunner(this);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("ScheduleRunner is about to start. Please set an id (Integer) such that the server can distinguish between multiple scheduleRunners: ");
		Scanner in = new Scanner(System.in);
		int id = in.nextInt();
		in.close();
		System.out.println("Accepted input.");
		ScheduleRunner scheduleRunner = new ScheduleRunner(id);
